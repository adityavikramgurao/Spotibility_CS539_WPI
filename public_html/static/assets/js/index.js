  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      var data = [
        ...
        {
            className: "graph2", // optional can be used for styling
            axes: b,
          },
      ];
    //   var data2 = [
    ...
    //     .attr("width", cfg.w + cfg.w + 50)
    //     .attr("height", cfg.h + cfg.h / 4);
    //   svg2.append("g").classed("single", 1).datum(data2).call(chart2);

      RadarChart.draw(chart1,data);
    //   RadarChart.draw(chart2,data2);
